...
readonly AMI_UBUNTU_HVM=ami-fd6cbd8a        # ubuntu 14.04, 64bit, HVM (for use with t2)
...
export SSH_FLAGS="-o BatchMode=yes -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null"
